...
const translations: TranslationSet = {
  ar: {
    ...
    "contact.address.value": "حي سلطان شيفتليجي، شارع غازي مصطفى كمال، رقم: 5B سلطان غازي، اسطنبول",
  ...
  tr: {
    ...
    "contact.address.value": "Sultançiftliği mah, Gazi Mustafa Kemal Cad, No: 5B Sultangazi, İstanbul",
