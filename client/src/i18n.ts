...
const translations: TranslationSet = {
  ar: {
    ...
    "admin.form.travel.price": "سعر السفري (₺)",
    "admin.form.travel.price.color": "لون سعر السفري",
  ...
  tr: {
    ...
    "admin.form.travel.price": "Seferi Fiyatı (₺)",
    "admin.form.travel.price.color": "Seferi Fiyatı Rengi",
