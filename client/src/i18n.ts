...
const translations: TranslationSet = {
  ar: {
    ...
    "contact.address.value": "شارع الاستقلال، تقسيم، اسطنبول، تركيا",
    "contact.phone.title": "الهاتف",
    "contact.phone.value": "+90 212 XXX XX XX",
  ...
  tr: {
    ...
    "contact.address.value": "İstiklal Caddesi, Taksim, İstanbul, Türkiye",
