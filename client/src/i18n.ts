...
const translations: TranslationSet = {
  ar: {
    ...
    "admin.form.travel.price": "سعر التوصيل (₺)",
    "admin.form.travel.price.color": "لون سعر التوصيل",
  ...
  tr: {
    ...
    "admin.form.travel.price": "Teslimat Fiyatı (₺)",
    "admin.form.travel.price.color": "Teslimat Fiyatı Rengi",
